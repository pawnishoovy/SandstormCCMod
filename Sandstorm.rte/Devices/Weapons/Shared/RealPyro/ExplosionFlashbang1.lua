...
function Create(self)
	...
	["Indoors"] = nil,
	["bigIndoors"] = nil};		
	self.addSounds.Outdoors = CreateSoundContainer("Explosion Specialty Flashbang Add", "Sandstorm.rte");
	self.addSounds.Indoors = CreateSoundContainer("Explosion Specialty Flashbang Add Indoors", "Sandstorm.rte");
	self.addSounds.bigIndoors = CreateSoundContainer("Explosion Specialty Flashbang Add Indoors", "Sandstorm.rte");
	...
	["Indoors"] = nil,
	["bigIndoors"] = nil};
	self.reflectionSounds.Outdoors = CreateSoundContainer("Explosion Specialty Flashbang Reflection Outdoors", "Sandstorm.rte");
