function Create(self)
	...
	self.addSounds.Start = CreateSoundContainer("AddStart ACE", "SandstormInsurgency.rte");
	self.addSounds.Loop = CreateSoundContainer("Add ACE", "SandstormInsurgency.rte");
	
	self.bassSounds = {["Start"] = nil, ["Loop"] = nil};
	self.bassSounds.Start = CreateSoundContainer("BassStart ACE", "SandstormInsurgency.rte");
	self.bassSounds.Loop = CreateSoundContainer("Bass ACE", "SandstormInsurgency.rte");
	
	self.mechSounds = {["Start"] = nil, ["Loop"] = nil, ["End"] = nil};
	self.mechSounds.Start = CreateSoundContainer("MechStart ACE", "SandstormInsurgency.rte");
	self.mechSounds.Loop = CreateSoundContainer("Mech ACE", "SandstormInsurgency.rte");
	self.mechSounds.End = CreateSoundContainer("MechEnd ACE", "SandstormInsurgency.rte");
	...
	self.reloadPrepareSounds.MagOut = CreateSoundContainer("MagOutPrepare ACE", "SandstormInsurgency.rte");
	self.reloadPrepareSounds.MagIn = CreateSoundContainer("MagInPrepare ACE", "SandstormInsurgency.rte");
	self.reloadPrepareSounds.BoltBack = CreateSoundContainer("BoltBackPrepare ACE", "SandstormInsurgency.rte");
	...
	self.reloadAfterSounds.MagOut = CreateSoundContainer("MagOut ACE", "SandstormInsurgency.rte");
	self.reloadAfterSounds.MagIn = CreateSoundContainer("MagIn ACE", "SandstormInsurgency.rte");
	self.reloadAfterSounds.BoltBack = CreateSoundContainer("BoltBack ACE", "SandstormInsurgency.rte");
	self.reloadAfterSounds.BoltForward = CreateSoundContainer("BoltForward ACE", "SandstormInsurgency.rte");
