function Create(self)
	...
	self.sharpAimSounds.In = CreateSoundContainer("SharpAimIn AKMN", "SandstormInsurgency.rte");
	self.sharpAimSounds.Out = CreateSoundContainer("SharpAimOut AKMN", "SandstormInsurgency.rte");		
	
	self.addSounds = {["Start"] = nil, ["Loop"] = nil};
	self.addSounds.Start = CreateSoundContainer("AddStart AKMN", "SandstormInsurgency.rte");
	self.addSounds.Loop = CreateSoundContainer("Add AKMN", "SandstormInsurgency.rte");
	
	self.bassSounds = {["Start"] = nil, ["Loop"] = nil};
	self.bassSounds.Start = CreateSoundContainer("BassStart AKMN", "SandstormInsurgency.rte");
	self.bassSounds.Loop = CreateSoundContainer("Bass AKMN", "SandstormInsurgency.rte");
	
	self.mechSounds = {["Start"] = nil, ["Loop"] = nil, ["End"] = nil};
	self.mechSounds.Start = CreateSoundContainer("MechStart AKMN", "SandstormInsurgency.rte");
	self.mechSounds.Loop = CreateSoundContainer("Mech AKMN", "SandstormInsurgency.rte");
	self.mechSounds.End = CreateSoundContainer("MechEnd AKMN", "SandstormInsurgency.rte");
	...
	self.reflectionSounds.Outdoors.Pitch = 0.98;
	
	self.reloadPrepareSounds = {["MagOut"] = nil, ["MagIn"] = nil, ["BoltBack"] = nil, ["BoltForward"] = nil}
	self.reloadPrepareSounds.MagOut = CreateSoundContainer("MagOutPrepare AKMN", "SandstormInsurgency.rte");
	self.reloadPrepareSounds.MagIn = CreateSoundContainer("MagInPrepare AKMN", "SandstormInsurgency.rte");
	self.reloadPrepareSounds.BoltBack = CreateSoundContainer("BoltBackPrepare AKMN", "SandstormInsurgency.rte");
	
	self.reloadPrepareLengths = {["MagOut"] = nil, ["MagIn"] = nil, ["BoltBack"] = nil, ["BoltForward"] = nil}
	self.reloadPrepareLengths.MagOut = 500;
	self.reloadPrepareLengths.MagIn = 1080;
	self.reloadPrepareLengths.BoltBack = 290;
	
	self.reloadAfterSounds = {["MagOut"] = nil, ["MagIn"] = nil, ["BoltBack"] = nil, ["BoltForward"] = nil}
	self.reloadAfterSounds.MagOut = CreateSoundContainer("MagOut AKMN", "SandstormInsurgency.rte");
	self.reloadAfterSounds.MagIn = CreateSoundContainer("MagIn AKMN", "SandstormInsurgency.rte");
	self.reloadAfterSounds.BoltBack = CreateSoundContainer("BoltBack AKMN", "SandstormInsurgency.rte");
	self.reloadAfterSounds.BoltForward = CreateSoundContainer("BoltForward AKMN", "SandstormInsurgency.rte");
