function Create(self)
	...
	self.sharpAimSounds.In = CreateSoundContainer("SharpAimIn AKS74U", "SandstormInsurgency.rte");
	self.sharpAimSounds.Out = CreateSoundContainer("SharpAimOut AKS74U", "SandstormInsurgency.rte");		
	
	self.addSounds = {["Start"] = nil, ["Loop"] = nil};
	self.addSounds.Start = CreateSoundContainer("AddStart AKS74U", "SandstormInsurgency.rte");
	self.addSounds.Loop = CreateSoundContainer("Add AKS74U", "SandstormInsurgency.rte");
	
	self.bassSounds = {["Start"] = nil, ["Loop"] = nil};
	self.bassSounds.Start = CreateSoundContainer("BassStart AKS74U", "SandstormInsurgency.rte");
	self.bassSounds.Loop = CreateSoundContainer("Bass AKS74U", "SandstormInsurgency.rte");
	
	self.mechSounds = {["Start"] = nil, ["Loop"] = nil, ["End"] = nil};
	self.mechSounds.Start = CreateSoundContainer("MechStart AKS74U", "SandstormInsurgency.rte");
	self.mechSounds.Loop = CreateSoundContainer("Mech AKS74U", "SandstormInsurgency.rte");
	self.mechSounds.End = CreateSoundContainer("MechEnd AKS74U", "SandstormInsurgency.rte");
	...
	self.reloadPrepareSounds.MagOut = CreateSoundContainer("MagOutPrepare AKS74U", "SandstormInsurgency.rte");
	self.reloadPrepareSounds.MagIn = CreateSoundContainer("MagInPrepare AKS74U", "SandstormInsurgency.rte");
	self.reloadPrepareSounds.BoltBack = CreateSoundContainer("BoltBackPrepare AKS74U", "SandstormInsurgency.rte");
	
	self.reloadPrepareLengths = {["MagOut"] = nil, ["MagIn"] = nil, ["BoltBack"] = nil, ["BoltForward"] = nil}
	self.reloadPrepareLengths.MagOut = 350;
	self.reloadPrepareLengths.MagIn = 940;
	self.reloadPrepareLengths.BoltBack = 290;
	
	self.reloadAfterSounds = {["MagOut"] = nil, ["MagIn"] = nil, ["BoltBack"] = nil, ["BoltForward"] = nil}
	self.reloadAfterSounds.MagOut = CreateSoundContainer("MagOut AKS74U", "SandstormInsurgency.rte");
	self.reloadAfterSounds.MagIn = CreateSoundContainer("MagIn AKS74U", "SandstormInsurgency.rte");
	self.reloadAfterSounds.BoltBack = CreateSoundContainer("BoltBack AKS74U", "SandstormInsurgency.rte");
	self.reloadAfterSounds.BoltForward = CreateSoundContainer("BoltForward AKS74U", "SandstormInsurgency.rte");
