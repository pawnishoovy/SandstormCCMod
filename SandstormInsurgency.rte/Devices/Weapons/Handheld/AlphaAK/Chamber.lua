function Create(self)
	...
	self.sharpAimSounds.In = CreateSoundContainer("SharpAimIn AlphaAK", "SandstormInsurgency.rte");
	self.sharpAimSounds.Out = CreateSoundContainer("SharpAimOut AlphaAK", "SandstormInsurgency.rte");		
	
	self.addSounds = {["Start"] = nil, ["Loop"] = nil};
	self.addSounds.Start = CreateSoundContainer("AddStart AlphaAK", "SandstormInsurgency.rte");
	self.addSounds.Loop = CreateSoundContainer("Add AlphaAK", "SandstormInsurgency.rte");
	
	self.bassSounds = {["Start"] = nil, ["Loop"] = nil};
	self.bassSounds.Start = CreateSoundContainer("BassStart AlphaAK", "SandstormInsurgency.rte");
	self.bassSounds.Loop = CreateSoundContainer("Bass AlphaAK", "SandstormInsurgency.rte");
	
	self.mechSounds = {["Start"] = nil, ["Loop"] = nil, ["End"] = nil};
	self.mechSounds.Start = CreateSoundContainer("MechStart AlphaAK", "SandstormInsurgency.rte");
	self.mechSounds.Loop = CreateSoundContainer("Mech AlphaAK", "SandstormInsurgency.rte");
	self.mechSounds.End = CreateSoundContainer("MechEnd AlphaAK", "SandstormInsurgency.rte");
	...
	self.reloadPrepareSounds.MagOut = CreateSoundContainer("MagOutPrepare AlphaAK", "SandstormInsurgency.rte");
	self.reloadPrepareSounds.MagIn = CreateSoundContainer("MagInPrepare AlphaAK", "SandstormInsurgency.rte");
	self.reloadPrepareSounds.BoltBack = CreateSoundContainer("BoltBackPrepare AlphaAK", "SandstormInsurgency.rte");
	
	self.reloadPrepareLengths = {["MagOut"] = nil, ["MagIn"] = nil, ["BoltBack"] = nil, ["BoltForward"] = nil}
	self.reloadPrepareLengths.MagOut = 1400;
	self.reloadPrepareLengths.MagIn = 500;
	self.reloadPrepareLengths.BoltBack = 240;
	
	self.reloadAfterSounds = {["MagOut"] = nil, ["MagIn"] = nil, ["BoltBack"] = nil, ["BoltForward"] = nil}
	self.reloadAfterSounds.MagOut = CreateSoundContainer("MagOut AlphaAK", "SandstormInsurgency.rte");
	self.reloadAfterSounds.MagIn = CreateSoundContainer("MagIn AlphaAK", "SandstormInsurgency.rte");
	self.reloadAfterSounds.BoltBack = CreateSoundContainer("BoltBack AlphaAK", "SandstormInsurgency.rte");
	self.reloadAfterSounds.BoltForward = CreateSoundContainer("BoltForward AlphaAK", "SandstormInsurgency.rte");
