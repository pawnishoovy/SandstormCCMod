function Create(self)
	...
	["Path"] = "SandstormInsurgency.rte/Devices/Weapons/Handheld/AlphaAK/CompliSoundV2/AddStart"};
	self.addSounds.Loop = {["Variations"] = 16,
	["Path"] = "SandstormInsurgency.rte/Devices/Weapons/Handheld/AlphaAK/CompliSoundV2/Add"};
	
	self.bassSounds = {["Start"] = nil, ["Loop"] = nil};
	self.bassSounds.Start = {["Variations"] = 4,
	["Path"] = "SandstormInsurgency.rte/Devices/Weapons/Handheld/AlphaAK/CompliSoundV2/BassStart"};
	self.bassSounds.Loop = {["Variations"] = 15,
	["Path"] = "SandstormInsurgency.rte/Devices/Weapons/Handheld/AlphaAK/CompliSoundV2/Bass"};
	
	self.mechSounds = {["Start"] = nil, ["Loop"] = nil, ["End"] = nil};
	self.mechSounds.Start = {["Variations"] = 4,
	["Path"] = "SandstormInsurgency.rte/Devices/Weapons/Handheld/AlphaAK/CompliSoundV2/MechStart"};
	self.mechSounds.Loop = {["Variations"] = 10,
	["Path"] = "SandstormInsurgency.rte/Devices/Weapons/Handheld/AlphaAK/CompliSoundV2/Mech"};
	self.mechSounds.End = {["Variations"] = 1,
	["Path"] = "SandstormInsurgency.rte/Devices/Weapons/Handheld/AlphaAK/CompliSoundV2/MechEnd"};
	...
	["Path"] = "SandstormInsurgency.rte/Devices/Weapons/Handheld/AlphaAK/CompliSoundV2/NoiseOutdoors"};
	self.noiseSounds.Outdoors.End = {["Variations"] = 4,
	["Path"] = "SandstormInsurgency.rte/Devices/Weapons/Handheld/AlphaAK/CompliSoundV2/NoiseOutdoorsEnd"};
	self.noiseSounds.Indoors.Loop = {["Variations"] = 5,
	["Path"] = "SandstormInsurgency.rte/Devices/Weapons/Handheld/AlphaAK/CompliSoundV2/NoiseIndoors"};
	self.noiseSounds.Indoors.End = {["Variations"] = 4,
	["Path"] = "SandstormInsurgency.rte/Devices/Weapons/Handheld/AlphaAK/CompliSoundV2/NoiseIndoorsEnd"};
	self.noiseSounds.bigIndoors.Loop = {["Variations"] = 5,
	["Path"] = "SandstormInsurgency.rte/Devices/Weapons/Handheld/AlphaAK/CompliSoundV2/NoiseBigIndoors"};
	self.noiseSounds.bigIndoors.End = {["Variations"] = 4,
	["Path"] = "SandstormInsurgency.rte/Devices/Weapons/Handheld/AlphaAK/CompliSoundV2/NoiseBigIndoorsEnd"};
	
	self.reflectionSounds = {["Outdoors"] = nil};
	self.reflectionSounds.Outdoors = {["Variations"] = 3,
	["Path"] = "SandstormInsurgency.rte/Devices/Weapons/Handheld/AlphaAK/CompliSoundV2/ReflectionOutdoors"};
	...
	self.magOutPrepareDelay = 1400;
	self.magOutAfterDelay = 200;
	self.magInPrepareDelay = 550;
	self.magInAfterDelay = 500;
	self.boltBackPrepareDelay = 600;
	self.boltBackAfterDelay = 75;
	...
	self.recoilStrength = 6.6 -- multiplier for base recoil added to the self.recoilStr when firing
...
function Update(self)
	...
	if self:IsReloading() then
		...
		if self.reloadPhase == 0 then
			...
			"SandstormInsurgency.rte/Devices/Weapons/Handheld/AlphaAK/Sounds/MagOutPrepare";
			self.afterSoundPath = 
			"SandstormInsurgency.rte/Devices/Weapons/Handheld/AlphaAK/Sounds/MagOut";
		...
		elseif self.reloadPhase == 1 then
			...
			self.prepareSoundPath = 
			"SandstormInsurgency.rte/Devices/Weapons/Handheld/AlphaAK/Sounds/MagInPrepare";
			self.afterSoundPath = 
			"SandstormInsurgency.rte/Devices/Weapons/Handheld/AlphaAK/Sounds/MagIn";
		...
		elseif self.reloadPhase == 2 then
			...
			self.prepareSoundPath = 
			"SandstormInsurgency.rte/Devices/Weapons/Handheld/AlphaAK/Sounds/BoltGrab";
			self.afterSoundPath = 
			"SandstormInsurgency.rte/Devices/Weapons/Handheld/AlphaAK/Sounds/BoltBack";
		...
		elseif self.reloadPhase == 3 then
			...
			self.afterSoundPath = 
			"SandstormInsurgency.rte/Devices/Weapons/Handheld/AlphaAK/Sounds/BoltForward";
		...
		if self.reloadTimer:IsPastSimMS(self.reloadDelay) then
			...
			if self.afterSoundPlayed ~= true then
				...
				if self.reloadPhase == 0 then
					self.phaseOnStop = 1;
					local fake
					fake = CreateMOSRotating("Fake Magazine MOSRotating AlphaAK");
					fake.Pos = self.Pos + Vector(0, 2):RadRotate(self.RotAngle);
					fake.Vel = self.Vel + Vector(3*self.FlipFactor, 1):RadRotate(self.RotAngle);
					fake.RotAngle = self.RotAngle;
					fake.AngularVel = self.AngularVel + (4*self.FlipFactor);
	...
	if self.FiredFrame then	
		...
		if self.parent then
			...
			if controller:IsState(Controller.BODY_CROUCH) then
				self.recoilStrength = 5.8
				self.recoilPowStrength = 0.5
				self.recoilRandomUpper = 1.8
				self.recoilDamping = 1.23
				
				self.recoilMax = 20
			else
				self.recoilStrength = 6.6
