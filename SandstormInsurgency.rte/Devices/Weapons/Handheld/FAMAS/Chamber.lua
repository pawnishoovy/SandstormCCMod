function Create(self)
	...
	self.sharpAimSounds.In = CreateSoundContainer("SharpAimIn BrowningHP", "SandstormInsurgency.rte");
	self.sharpAimSounds.Out = CreateSoundContainer("SharpAimOut BrowningHP", "SandstormInsurgency.rte");	
	
	self.addSounds = {["Start"] = nil, ["Loop"] = nil};
	self.addSounds.Start = CreateSoundContainer("AddStart FAMAS", "SandstormInsurgency.rte");
	self.addSounds.Loop = CreateSoundContainer("Add FAMAS", "SandstormInsurgency.rte");
	
	self.bassSounds = {["Start"] = nil, ["Loop"] = nil};
	self.bassSounds.Start = CreateSoundContainer("BassStart FAMAS", "SandstormInsurgency.rte");
	self.bassSounds.Loop = CreateSoundContainer("Bass FAMAS", "SandstormInsurgency.rte");
	
	self.mechSounds = {["Start"] = nil, ["Loop"] = nil, ["End"] = nil};
	self.mechSounds.Start = CreateSoundContainer("MechStart FAMAS", "SandstormInsurgency.rte");
	self.mechSounds.Loop = CreateSoundContainer("Mech FAMAS", "SandstormInsurgency.rte");
	self.mechSounds.End = CreateSoundContainer("MechEnd FAMAS", "SandstormInsurgency.rte");
	...
	self.reloadPrepareSounds.MagOut = CreateSoundContainer("MagOutPrepare FAMAS", "SandstormInsurgency.rte");
	self.reloadPrepareSounds.MagIn = CreateSoundContainer("MagInPrepare FAMAS", "SandstormInsurgency.rte");
	self.reloadPrepareSounds.BoltBack = CreateSoundContainer("BoltBackPrepare FAMAS", "SandstormInsurgency.rte");
	
	self.reloadPrepareLengths = {["MagOut"] = nil, ["MagIn"] = nil, ["BoltBack"] = nil, ["BoltForward"] = nil}
	self.reloadPrepareLengths.MagOut = 550;
	self.reloadPrepareLengths.MagIn = 1120;
	self.reloadPrepareLengths.BoltBack = 400;
	
	self.reloadAfterSounds = {["MagOut"] = nil, ["MagIn"] = nil, ["BoltBack"] = nil, ["BoltForward"] = nil}
	self.reloadAfterSounds.MagOut = CreateSoundContainer("MagOut FAMAS", "SandstormInsurgency.rte");
	self.reloadAfterSounds.MagIn = CreateSoundContainer("MagIn FAMAS", "SandstormInsurgency.rte");
	self.reloadAfterSounds.BoltBack = CreateSoundContainer("BoltBack FAMAS", "SandstormInsurgency.rte");
	self.reloadAfterSounds.BoltForward = CreateSoundContainer("BoltForward FAMAS", "SandstormInsurgency.rte");
