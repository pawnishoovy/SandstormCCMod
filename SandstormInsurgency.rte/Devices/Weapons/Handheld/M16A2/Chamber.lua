function Create(self)
	...
	self.addSounds.Start = CreateSoundContainer("AddStart M16A2", "SandstormInsurgency.rte");
	self.addSounds.Loop = CreateSoundContainer("Add M16A2", "SandstormInsurgency.rte");
	
	self.bassSounds = {["Loop"] = nil};
	self.bassSounds.Loop = CreateSoundContainer("Bass M16A2", "SandstormInsurgency.rte");
	
	self.mechSounds = {["Start"] = nil, ["Loop"] = nil, ["End"] = nil};
	self.mechSounds.Loop = CreateSoundContainer("Mech M16A2", "SandstormInsurgency.rte");
	self.mechSounds.End = CreateSoundContainer("MechEnd M16A2", "SandstormInsurgency.rte");
	...
	self.reloadPrepareSounds.MagOut = CreateSoundContainer("MagOutPrepare M16A2", "SandstormInsurgency.rte");
	self.reloadPrepareSounds.MagIn = CreateSoundContainer("MagInPrepare M16A2", "SandstormInsurgency.rte");
	...
	self.reloadAfterSounds.MagOut = CreateSoundContainer("MagOut M16A2", "SandstormInsurgency.rte");
	self.reloadAfterSounds.MagIn = CreateSoundContainer("MagIn M16A2", "SandstormInsurgency.rte");
	self.reloadAfterSounds.MagHit = CreateSoundContainer("MagHit M16A2", "SandstormInsurgency.rte");
	self.reloadAfterSounds.BoltForwardRelease = CreateSoundContainer("BoltRelease M16A2", "SandstormInsurgency.rte");
	self.reloadAfterSounds.BoltBack = CreateSoundContainer("BoltBack M16A2", "SandstormInsurgency.rte");
	self.reloadAfterSounds.BoltForward = CreateSoundContainer("BoltForward M16A2", "SandstormInsurgency.rte");
		...
		if self.reloadTimer:IsPastSimMS(self.reloadDelay) then
			...
			if self.afterSoundPlayed ~= true then
				...
				if self.reloadPhase == 0 then
					self.phaseOnStop = 1;
					local fake
					fake = CreateMOSRotating("Fake Magazine MOSRotating M16A2");
