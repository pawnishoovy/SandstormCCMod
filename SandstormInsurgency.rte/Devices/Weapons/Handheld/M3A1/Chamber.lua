function Create(self)
	...
	self.sharpAimSounds.In = CreateSoundContainer("SharpAimIn M3A1", "SandstormInsurgency.rte");
	self.sharpAimSounds.Out = CreateSoundContainer("SharpAimOut M3A1", "SandstormInsurgency.rte");	
	
	self.preSound = CreateSoundContainer("Pre M3A1", "SandstormInsurgency.rte");
	self.boltDropSound = CreateSoundContainer("BoltDrop M3A1", "SandstormInsurgency.rte");
	
	self.addSounds = {["Start"] = nil, ["Loop"] = nil};
	self.addSounds.Start = CreateSoundContainer("AddStart M3A1", "SandstormInsurgency.rte");
	self.addSounds.Loop = CreateSoundContainer("Add M3A1", "SandstormInsurgency.rte");
	
	self.bassSounds = {["Start"] = nil, ["Loop"] = nil};
	self.bassSounds.Start = CreateSoundContainer("BassStart M3A1", "SandstormInsurgency.rte");
	self.bassSounds.Loop = CreateSoundContainer("Bass M3A1", "SandstormInsurgency.rte");
	
	self.mechSounds = {["Start"] = nil, ["Loop"] = nil, ["End"] = nil};
	self.mechSounds.Start = CreateSoundContainer("MechStart M3A1", "SandstormInsurgency.rte");
	self.mechSounds.Loop = CreateSoundContainer("Mech M3A1", "SandstormInsurgency.rte");
	self.mechSounds.End = CreateSoundContainer("MechEnd M3A1", "SandstormInsurgency.rte");
	...
	self.noiseSounds.Outdoors.Loop.Volume = 0.2;
	...
	self.noiseSounds.bigIndoors.Loop.Volume = 0.2;
	...
	self.noiseSounds.bigIndoors.End.Volume = 0.2;
	
	self.reloadPrepareSounds = {["MagOut"] = nil, ["MagIn"] = nil, ["BoltBack"] = nil, ["BoltForward"] = nil}
	self.reloadPrepareSounds.MagOut = CreateSoundContainer("MagOutPrepare M3A1", "SandstormInsurgency.rte");
	self.reloadPrepareSounds.MagIn = CreateSoundContainer("MagInPrepare M3A1", "SandstormInsurgency.rte");
	self.reloadPrepareSounds.BoltBack = CreateSoundContainer("BoltBackPrepare M3A1", "SandstormInsurgency.rte");
	
	self.reloadPrepareLengths = {["MagOut"] = nil, ["MagIn"] = nil, ["BoltBack"] = nil, ["BoltForward"] = nil}
	self.reloadPrepareLengths.MagOut = 450;
	self.reloadPrepareLengths.MagIn = 950;
	self.reloadPrepareLengths.BoltBack = 120;
	
	self.reloadAfterSounds = {["MagOut"] = nil, ["MagIn"] = nil, ["BoltBack"] = nil, ["BoltForward"] = nil}
	self.reloadAfterSounds.MagOut = CreateSoundContainer("MagOut M3A1", "SandstormInsurgency.rte");
	self.reloadAfterSounds.MagIn = CreateSoundContainer("MagIn M3A1", "SandstormInsurgency.rte");
	self.reloadAfterSounds.BoltBack = CreateSoundContainer("BoltBack M3A1", "SandstormInsurgency.rte");
...
function Update(self)
		...
		if self.reloadTimer:IsPastSimMS(self.reloadDelay) then
			...
			if self.afterSoundPlayed ~= true then
				...
				if self.reloadPhase == 0 then
					self.phaseOnStop = 1;
					local fake
					fake = CreateMOSRotating("Fake Magazine MOSRotating M3A1");
					fake.Pos = self.Pos + Vector(1*self.FlipFactor, 5):RadRotate(self.RotAngle);
	...
	if self.backFrame == true then
		...
		self.Frame = 1 + math.floor((factor) * 6 + 0.5)
