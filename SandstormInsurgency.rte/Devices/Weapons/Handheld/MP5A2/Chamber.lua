function Create(self)
	...
	["Path"] = "SandstormInsurgency.rte/Devices/Weapons/Handheld/MP5A2/CompliSoundV2/AddStart"};
	self.addSounds.Loop = {["Variations"] = 15,
	["Path"] = "SandstormInsurgency.rte/Devices/Weapons/Handheld/MP5A2/CompliSoundV2/Add"};
	
	self.bassSounds = {["Start"] = nil, ["Loop"] = nil};
	self.bassSounds.Start = {["Variations"] = 4,
	["Path"] = "SandstormInsurgency.rte/Devices/Weapons/Handheld/MP5A2/CompliSoundV2/BassStart"};
	self.bassSounds.Loop = {["Variations"] = 15,
	["Path"] = "SandstormInsurgency.rte/Devices/Weapons/Handheld/MP5A2/CompliSoundV2/Bass"};
	
	self.mechSounds = {["Loop"] = nil, ["End"] = nil};
	self.mechSounds.Loop = {["Variations"] = 15,
	["Path"] = "SandstormInsurgency.rte/Devices/Weapons/Handheld/MP5A2/CompliSoundV2/Mech"};
	self.mechSounds.End = {["Variations"] = 1,
	["Path"] = "SandstormInsurgency.rte/Devices/Weapons/Handheld/MP5A2/CompliSoundV2/MechEnd"};
	...
	["Path"] = "SandstormInsurgency.rte/Devices/Weapons/Handheld/MP5A2/CompliSoundV2/NoiseOutdoors"};
	self.noiseSounds.Outdoors.End = {["Variations"] = 4,
	["Path"] = "SandstormInsurgency.rte/Devices/Weapons/Handheld/MP5A2/CompliSoundV2/NoiseOutdoorsEnd"};
	self.noiseSounds.Indoors.Loop = {["Variations"] = 15,
	["Path"] = "SandstormInsurgency.rte/Devices/Weapons/Handheld/MP5A2/CompliSoundV2/NoiseIndoors"};
	self.noiseSounds.Indoors.End = {["Variations"] = 8,
	["Path"] = "SandstormInsurgency.rte/Devices/Weapons/Handheld/MP5A2/CompliSoundV2/NoiseIndoorsEnd"};
	self.noiseSounds.bigIndoors.Loop = {["Variations"] = 15,
	["Path"] = "SandstormInsurgency.rte/Devices/Weapons/Handheld/MP5A2/CompliSoundV2/NoiseBigIndoors"};
	self.noiseSounds.bigIndoors.End = {["Variations"] = 6,
	["Path"] = "SandstormInsurgency.rte/Devices/Weapons/Handheld/MP5A2/CompliSoundV2/NoiseBigIndoorsEnd"};
	
	self.reflectionSounds = {["Outdoors"] = nil};
	self.reflectionSounds.Outdoors = {["Variations"] = 3,
	["Path"] = "SandstormInsurgency.rte/Devices/Weapons/Handheld/MP5A2/CompliSoundV2/ReflectionOutdoors"};
...
function Update(self)
	...
	if self:IsReloading() then
		...
		if self.reloadPhase == 0 then
			...
			"SandstormInsurgency.rte/Devices/Weapons/Handheld/MP5A2/Sounds/BoltBackPrepare";
			self.afterSoundPath = 
			"SandstormInsurgency.rte/Devices/Weapons/Handheld/MP5A2/Sounds/BoltBack";
		...
		elseif self.reloadPhase == 1 then
			...
			self.afterSoundPath = 
			"SandstormInsurgency.rte/Devices/Weapons/Handheld/MP5A2/Sounds/BoltLock";
		...
		elseif self.reloadPhase == 2 then
			...
			self.prepareSoundPath = nil;
			self.afterSoundPath = 
			"SandstormInsurgency.rte/Devices/Weapons/Handheld/MP5A2/Sounds/MagOut";
		...
		elseif self.reloadPhase == 3 then
			...
			self.prepareSoundPath = 
			"SandstormInsurgency.rte/Devices/Weapons/Handheld/MP5A2/Sounds/MagInPrepare";
			self.afterSoundPath = 
			"SandstormInsurgency.rte/Devices/Weapons/Handheld/MP5A2/Sounds/MagIn";
		...
		elseif self.reloadPhase == 4 then
			...
			self.prepareSoundPath = nil;
			self.afterSoundPath = 
			"SandstormInsurgency.rte/Devices/Weapons/Handheld/MP5A2/Sounds/BoltSlap";
