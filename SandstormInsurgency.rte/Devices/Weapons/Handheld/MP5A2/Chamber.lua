function Create(self)
	...
	self.sharpAimSounds.In = CreateSoundContainer("SharpAimIn MP5A2", "SandstormInsurgency.rte");
	self.sharpAimSounds.Out = CreateSoundContainer("SharpAimOut MP5A2", "SandstormInsurgency.rte");	
	
	self.addSounds = {["Start"] = nil, ["Loop"] = nil};
	self.addSounds.Start = CreateSoundContainer("AddStart MP5A2", "SandstormInsurgency.rte");
	self.addSounds.Loop = CreateSoundContainer("Add MP5A2", "SandstormInsurgency.rte");
	
	self.bassSounds = {["Start"] = nil, ["Loop"] = nil};
	self.bassSounds.Start = CreateSoundContainer("BassStart MP5A2", "SandstormInsurgency.rte");
	self.bassSounds.Loop = CreateSoundContainer("Bass MP5A2", "SandstormInsurgency.rte");
	
	self.mechSounds = {["Start"] = nil, ["Loop"] = nil, ["End"] = nil};
	self.mechSounds.Loop = CreateSoundContainer("Mech MP5A2", "SandstormInsurgency.rte");
	self.mechSounds.End = CreateSoundContainer("MechEnd MP5A2", "SandstormInsurgency.rte");
	...
	self.reloadPrepareSounds = {["BoltBack"] = nil, ["BoltLock"] = nil, ["MagOut"] = nil, ["MagIn"] = nil, ["BoltSlap"] = nil}
	self.reloadPrepareSounds.BoltBack = CreateSoundContainer("BoltBackPrepare MP5A2", "SandstormInsurgency.rte");
	self.reloadPrepareSounds.MagOut = CreateSoundContainer("MagOutPrepare MP5A2", "SandstormInsurgency.rte");
	self.reloadPrepareSounds.MagIn = CreateSoundContainer("MagInPrepare MP5A2", "SandstormInsurgency.rte");
	
	self.reloadPrepareLengths = {["BoltBack"] = nil, ["BoltLock"] = nil, ["MagOut"] = nil, ["MagIn"] = nil, ["BoltSlap"] = nil}
	self.reloadPrepareLengths.BoltBack = 450;
	self.reloadPrepareLengths.MagOut = 300;
	self.reloadPrepareLengths.MagIn = 450;
	
	self.reloadAfterSounds = {["BoltBack"] = nil, ["BoltLock"] = nil, ["MagOut"] = nil, ["MagIn"] = nil, ["BoltSlap"] = nil}
	self.reloadAfterSounds.BoltBack = CreateSoundContainer("BoltBack MP5A2", "SandstormInsurgency.rte");
	self.reloadAfterSounds.BoltLock = CreateSoundContainer("BoltLock MP5A2", "SandstormInsurgency.rte");
	self.reloadAfterSounds.MagOut = CreateSoundContainer("MagOut MP5A2", "SandstormInsurgency.rte");
	self.reloadAfterSounds.MagIn = CreateSoundContainer("MagIn MP5A2", "SandstormInsurgency.rte");
	self.reloadAfterSounds.BoltSlap = CreateSoundContainer("BoltSlap MP5A2", "SandstormInsurgency.rte");
	...
	self.recoilStrength = 4.7 -- multiplier for base recoil added to the self.recoilStr when firing
...
function Update(self)
	...
	if self:IsReloading() then
		...
		elseif self.reloadPhase == 1 then
			...
			self.afterSound = self.reloadAfterSounds.BoltLock;
		...
		elseif self.reloadPhase == 4 then
			...
			self.prepareSound = nil;
			self.prepareSoundLength = 0;
			self.afterSound = self.reloadAfterSounds.BoltSlap;
		...
		if self.reloadTimer:IsPastSimMS(self.reloadDelay) then
			...
			if self.afterSoundPlayed ~= true then
				...
				if self.reloadPhase == 2 then
					local fake
					fake = CreateMOSRotating("Fake Magazine MOSRotating MP5A2");
					...
					fake:SetStringValue("MagazineType", "Small Poly");
