function Create(self)
	...
	self.sharpAimSounds.In = CreateSoundContainer("SharpAimIn RPK74", "SandstormInsurgency.rte");
	self.sharpAimSounds.Out = CreateSoundContainer("SharpAimOut RPK74", "SandstormInsurgency.rte");		
	
	self.addSounds = {["Start"] = nil, ["Loop"] = nil};
	self.addSounds.Start = CreateSoundContainer("AddStart RPK74", "SandstormInsurgency.rte");
	self.addSounds.Loop = CreateSoundContainer("Add RPK74", "SandstormInsurgency.rte");
	
	self.bassSounds = {["Start"] = nil, ["Loop"] = nil};
	self.bassSounds.Start = CreateSoundContainer("BassStart RPK74", "SandstormInsurgency.rte");
	self.bassSounds.Loop = CreateSoundContainer("Bass RPK74", "SandstormInsurgency.rte");
	
	self.mechSounds = {["Start"] = nil, ["Loop"] = nil, ["End"] = nil};
	self.mechSounds.Start = CreateSoundContainer("MechStart RPK74", "SandstormInsurgency.rte");
	self.mechSounds.Loop = CreateSoundContainer("Mech RPK74", "SandstormInsurgency.rte");
	self.mechSounds.End = CreateSoundContainer("MechEnd RPK74", "SandstormInsurgency.rte");
	...
	self.reloadPrepareSounds.MagOut = CreateSoundContainer("MagOutPrepare RPK74", "SandstormInsurgency.rte");
	self.reloadPrepareSounds.MagIn = CreateSoundContainer("MagInPrepare RPK74", "SandstormInsurgency.rte");
	self.reloadPrepareSounds.MagHit = CreateSoundContainer("MagHitPrepare RPK74", "SandstormInsurgency.rte");
	self.reloadPrepareSounds.BoltBack = CreateSoundContainer("BoltBackPrepare RPK74", "SandstormInsurgency.rte");
	
	self.reloadPrepareLengths = {["MagOut"] = nil, ["MagIn"] = nil, ["BoltBack"] = nil, ["BoltForward"] = nil}
	self.reloadPrepareLengths.MagOut = 1000;
	self.reloadPrepareLengths.MagIn = 1300;
	self.reloadPrepareLengths.MagHit = 400;
	self.reloadPrepareLengths.BoltBack = 400;
	
	self.reloadAfterSounds = {["MagOut"] = nil, ["MagIn"] = nil, ["BoltBack"] = nil, ["BoltForward"] = nil}
	self.reloadAfterSounds.MagOut = CreateSoundContainer("MagOut RPK74", "SandstormInsurgency.rte");
	self.reloadAfterSounds.MagIn = CreateSoundContainer("MagIn RPK74", "SandstormInsurgency.rte");
	self.reloadAfterSounds.MagHit = CreateSoundContainer("MagHit RPK74", "SandstormInsurgency.rte");
	self.reloadAfterSounds.BoltBack = CreateSoundContainer("BoltBack RPK74", "SandstormInsurgency.rte");
	self.reloadAfterSounds.BoltForward = CreateSoundContainer("BoltForward RPK74", "SandstormInsurgency.rte");
