function Create(self)
	...
	["Path"] = "SandstormInsurgency.rte/Devices/Weapons/Handheld/SKS/CompliSoundV2/Pre"};		
	
	self.addSounds = {["Loop"] = nil};
	self.addSounds.Loop = {["Variations"] = 4,
	["Path"] = "SandstormInsurgency.rte/Devices/Weapons/Handheld/SKS/CompliSoundV2/Add"};
	
	self.bassSounds = {["Loop"] = nil};
	self.bassSounds.Loop = {["Variations"] = 1,
	["Path"] = "SandstormInsurgency.rte/Devices/Weapons/Handheld/SKS/CompliSoundV2/Bass"};
	
	self.mechSounds = {["Loop"] = nil};
	self.mechSounds.Loop = {["Variations"] = 3,
	["Path"] = "SandstormInsurgency.rte/Devices/Weapons/Handheld/SKS/CompliSoundV2/Mech"};
	...
	["Path"] = "SandstormInsurgency.rte/Devices/Weapons/Handheld/SKS/CompliSoundV2/NoiseOutdoorsEnd"};
	self.noiseSounds.Indoors.End = {["Variations"] = 6,
	["Path"] = "SandstormInsurgency.rte/Devices/Weapons/Handheld/SKS/CompliSoundV2/NoiseIndoorsEnd"};
	self.noiseSounds.bigIndoors.End = {["Variations"] = 6,
	["Path"] = "SandstormInsurgency.rte/Devices/Weapons/Handheld/SKS/CompliSoundV2/NoiseBigIndoorsEnd"};
	
	self.reflectionSounds = {["Outdoors"] = nil};
	self.reflectionSounds.Outdoors = {["Variations"] = 3,
	["Path"] = "SandstormInsurgency.rte/Devices/Weapons/Handheld/SKS/CompliSoundV2/ReflectionOutdoors"};
...
function Update(self)
	...
	if self:IsReloading() then
		...
		if self.reloadPhase == 0 then
			...
			"SandstormInsurgency.rte/Devices/Weapons/Handheld/SKS/Sounds/MagOutPrepare1";
			self.afterSoundPath = 
			"SandstormInsurgency.rte/Devices/Weapons/Handheld/SKS/Sounds/MagOut1";
		...
		elseif self.reloadPhase == 1 then
			...
			self.prepareSoundPath = 
			"SandstormInsurgency.rte/Devices/Weapons/Handheld/SKS/Sounds/MagInPrepare1";
			self.afterSoundPath = 
			"SandstormInsurgency.rte/Devices/Weapons/Handheld/SKS/Sounds/MagIn1";
		...
		elseif self.reloadPhase == 2 then
			...
			self.afterSoundPath = 
			"SandstormInsurgency.rte/Devices/Weapons/Handheld/SKS/Sounds/BoltBack1";	
		...
		elseif self.reloadPhase == 3 then
			...
			self.prepareSoundPath = nil;
			self.afterSoundPath = 
			"SandstormInsurgency.rte/Devices/Weapons/Handheld/SKS/Sounds/BoltForward1";
