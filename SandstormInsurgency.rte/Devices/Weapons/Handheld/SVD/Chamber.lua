function Create(self)
	...
	self.preSound = CreateSoundContainer("Pre SVD", "SandstormInsurgency.rte");
	
	self.sharpAimSounds = {["In"] = nil, ["Out"] = nil};
	self.sharpAimSounds.In = CreateSoundContainer("SharpAimIn SVD", "SandstormInsurgency.rte");
	self.sharpAimSounds.Out = CreateSoundContainer("SharpAimOut SVD", "SandstormInsurgency.rte");
	
	self.addSounds = {["Loop"] = nil};
	self.addSounds.Loop = CreateSoundContainer("Add SVD", "SandstormInsurgency.rte");
	
	self.bassSounds = {["Loop"] = nil};
	self.bassSounds.Loop = CreateSoundContainer("Bass SVD", "SandstormInsurgency.rte");
	
	self.mechSounds = {["Loop"] = nil};
	self.mechSounds.Loop = CreateSoundContainer("Mech SVD", "SandstormInsurgency.rte");
	
	self.noiseSounds = {["Outdoors"] = {["Loop"] = nil, ["End"] = nil},
	["Indoors"] = {["Loop"] = nil, ["End"] = nil},
	["bigIndoors"] = {["Loop"] = nil, ["End"] = nil}};
	self.noiseSounds.Outdoors.End = CreateSoundContainer("NoiseOutdoorsEnd SVD", "SandstormInsurgency.rte");
	self.noiseSounds.Outdoors.End.Pitch = 1.0;
	self.noiseSounds.Indoors.End = CreateSoundContainer("NoiseIndoorsEnd SVD", "SandstormInsurgency.rte");
	self.noiseSounds.Indoors.End.Pitch = 1.0;
	self.noiseSounds.bigIndoors.End = CreateSoundContainer("NoiseBigIndoorsEnd SVD", "SandstormInsurgency.rte");
	self.noiseSounds.bigIndoors.End.Pitch = 1.0;
	
	self.reflectionSounds = {["Outdoors"] = nil};
	self.reflectionSounds.Outdoors = CreateSoundContainer("ReflectionOutdoors SVD", "SandstormInsurgency.rte");
	self.reflectionSounds.Outdoors.Pitch = 1.0
	
	self.reloadPrepareSounds = {["MagOut"] = nil, ["MagIn"] = nil, ["BoltBack"] = nil, ["BoltForward"] = nil}
	self.reloadPrepareSounds.MagOut = CreateSoundContainer("MagOutPrepare SVD", "SandstormInsurgency.rte");
	self.reloadPrepareSounds.MagIn = CreateSoundContainer("MagInPrepare SVD", "SandstormInsurgency.rte");
	
	self.reloadPrepareLengths = {["MagOut"] = nil, ["MagIn"] = nil, ["BoltBack"] = nil, ["BoltForward"] = nil}
	self.reloadPrepareLengths.MagOut = 700;
	self.reloadPrepareLengths.MagIn = 750;
	
	self.reloadAfterSounds = {["MagOut"] = nil, ["MagIn"] = nil, ["BoltBack"] = nil, ["BoltForward"] = nil}
	self.reloadAfterSounds.MagOut = CreateSoundContainer("MagOut SVD", "SandstormInsurgency.rte");
	self.reloadAfterSounds.MagInEmpty = CreateSoundContainer("MagInEmpty SVD", "SandstormInsurgency.rte");
	self.reloadAfterSounds.MagInFull = CreateSoundContainer("MagInFull SVD", "SandstormInsurgency.rte");
	self.reloadAfterSounds.MagHit = CreateSoundContainer("MagHit SVD", "SandstormInsurgency.rte");
	self.reloadAfterSounds.BoltBack = CreateSoundContainer("BoltBack SVD", "SandstormInsurgency.rte");
	self.reloadAfterSounds.BoltForward = CreateSoundContainer("BoltForward SVD", "SandstormInsurgency.rte");
	...
	if self:IsReloading() then
		...
		elseif self.reloadPhase == 1 then
			...
			if self.chamberOnReload then
				self.afterSound = self.reloadAfterSounds.MagInEmpty;
			else
