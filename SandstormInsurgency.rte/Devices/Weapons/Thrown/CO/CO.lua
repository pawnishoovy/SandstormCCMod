function Create(self)
	...
	self.pullPinSound = CreateSoundContainer("CO PullPin", "SandstormInsurgency.rte");
	self.spoonEjectSound = CreateSoundContainer("CO SpoonEject", "SandstormInsurgency.rte");
	...
	self.terrainSounds = {
	Hard = {[12] = CreateSoundContainer("Flash Impact Hard Concrete", "Sandstorm.rte"),
			[164] = CreateSoundContainer("Flash Impact Hard Concrete", "Sandstorm.rte"),
			[177] = CreateSoundContainer("Flash Impact Hard Concrete", "Sandstorm.rte"),
			[9] = CreateSoundContainer("Flash Impact Hard Dirt", "Sandstorm.rte"),
			[10] = CreateSoundContainer("Flash Impact Hard Dirt", "Sandstorm.rte"),
			[11] = CreateSoundContainer("Flash Impact Hard Dirt", "Sandstorm.rte"),
			[128] = CreateSoundContainer("Flash Impact Hard Dirt", "Sandstorm.rte"),
			[6] = CreateSoundContainer("Frag Impact Hard Sand", "Sandstorm.rte"),
			[8] = CreateSoundContainer("Frag Impact Hard Sand", "Sandstorm.rte"),
			[178] = CreateSoundContainer("Flash Impact Hard SolidMetal", "Sandstorm.rte"),
			[179] = CreateSoundContainer("Flash Impact Hard SolidMetal", "Sandstorm.rte"),
			[180] = CreateSoundContainer("Flash Impact Hard SolidMetal", "Sandstorm.rte"),
			[181] = CreateSoundContainer("Flash Impact Hard SolidMetal", "Sandstorm.rte"),
			[182] = CreateSoundContainer("Flash Impact Hard SolidMetal", "Sandstorm.rte")},
	Medium = {[12] = CreateSoundContainer("Flash Impact Medium Concrete", "Sandstorm.rte"),
			[164] = CreateSoundContainer("Flash Impact Medium Concrete", "Sandstorm.rte"),
			[177] = CreateSoundContainer("Flash Impact Medium Concrete", "Sandstorm.rte"),
			[9] = CreateSoundContainer("Flash Impact Medium Dirt", "Sandstorm.rte"),
			[10] = CreateSoundContainer("Flash Impact Medium Dirt", "Sandstorm.rte"),
			[11] = CreateSoundContainer("Flash Impact Medium Dirt", "Sandstorm.rte"),
			[128] = CreateSoundContainer("Flash Impact Medium Dirt", "Sandstorm.rte"),
			[6] = CreateSoundContainer("Frag Impact Medium Sand", "Sandstorm.rte"),
			[8] = CreateSoundContainer("Frag Impact Medium Sand", "Sandstorm.rte"),
			[178] = CreateSoundContainer("Flash Impact Medium SolidMetal", "Sandstorm.rte"),
			[179] = CreateSoundContainer("Flash Impact Medium SolidMetal", "Sandstorm.rte"),
			[180] = CreateSoundContainer("Flash Impact Medium SolidMetal", "Sandstorm.rte"),
			[181] = CreateSoundContainer("Flash Impact Medium SolidMetal", "Sandstorm.rte"),
			[182] = CreateSoundContainer("Flash Impact Medium SolidMetal", "Sandstorm.rte")},
	Soft = {[12] = CreateSoundContainer("Flash Impact Soft Concrete", "Sandstorm.rte"),
			[164] = CreateSoundContainer("Flash Impact Soft Concrete", "Sandstorm.rte"),
			[177] = CreateSoundContainer("Flash Impact Soft Concrete", "Sandstorm.rte"),
			[9] = CreateSoundContainer("Flash Impact Soft Dirt", "Sandstorm.rte"),
			[10] = CreateSoundContainer("Flash Impact Soft Dirt", "Sandstorm.rte"),
			[11] = CreateSoundContainer("Flash Impact Soft Dirt", "Sandstorm.rte"),
			[128] = CreateSoundContainer("Flash Impact Soft Dirt", "Sandstorm.rte"),
			[6] = CreateSoundContainer("Frag Impact Soft Sand", "Sandstorm.rte"),
			[8] = CreateSoundContainer("Frag Impact Soft Sand", "Sandstorm.rte"),
			[178] = CreateSoundContainer("Flash Impact Soft SolidMetal", "Sandstorm.rte"),
			[179] = CreateSoundContainer("Flash Impact Soft SolidMetal", "Sandstorm.rte"),
			[180] = CreateSoundContainer("Flash Impact Soft SolidMetal", "Sandstorm.rte"),
			[181] = CreateSoundContainer("Flash Impact Soft SolidMetal", "Sandstorm.rte"),
			[182] = CreateSoundContainer("Flash Impact Soft SolidMetal", "Sandstorm.rte")},
...
function Update(self)
	...
	if not self:IsAttached() then
		if self.Live ~= true and self.pinPulled then
			...
			self.Live = true;
			local spoon = CreateMOSParticle("CO Grenade Spoon");
			spoon.Pos = self.Pos;
	...
	if self:IsActivated() and self.pinPulled ~= true then	
		...
		local pin = CreateMOSParticle("CO Grenade Pin");
		pin.Pos = self.Pos;
