...
function Update(self)
	...
	if self:IsReloading() then
		...
		if self.reloadPhase == 0 then
			...
			"SandstormSecurity.rte/Devices/Weapons/Handheld/GalilSAR/Sounds/MagOutPrepare";
			self.afterSoundPath = 
			"SandstormSecurity.rte/Devices/Weapons/Handheld/GalilSAR/Sounds/MagOut";
		...
		elseif self.reloadPhase == 1 then
			...
			self.afterSoundPath = 
			"SandstormSecurity.rte/Devices/Weapons/Handheld/GalilSAR/Sounds/MagIn";
		...
		elseif self.reloadPhase == 2 then
			...
			self.prepareSoundPath = 
			"SandstormSecurity.rte/Devices/Weapons/Handheld/GalilSAR/Sounds/BoltGrab";
			self.afterSoundPath = 
			"SandstormSecurity.rte/Devices/Weapons/Handheld/GalilSAR/Sounds/BoltBack";
		...
		elseif self.reloadPhase == 3 then
			...
			self.prepareSoundPath = nil;
			self.afterSoundPath = 
			"SandstormSecurity.rte/Devices/Weapons/Handheld/GalilSAR/Sounds/BoltForward";
