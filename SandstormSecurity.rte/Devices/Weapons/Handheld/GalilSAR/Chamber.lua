function Create(self)
	...
	self.addSounds.Start = CreateSoundContainer("AddStart GalilSAR", "SandstormSecurity.rte");
	self.addSounds.Loop = CreateSoundContainer("Add GalilSAR", "SandstormSecurity.rte");
	
	self.bassSounds = {["Start"] = nil, ["Loop"] = nil};
	self.bassSounds.Start = CreateSoundContainer("BassStart GalilSAR", "SandstormSecurity.rte");
	self.bassSounds.Loop = CreateSoundContainer("Bass GalilSAR", "SandstormSecurity.rte");
	
	self.mechSounds = {["Start"] = nil, ["Loop"] = nil, ["End"] = nil};
	self.mechSounds.Start = CreateSoundContainer("MechStart GalilSAR", "SandstormSecurity.rte");
	self.mechSounds.Loop = CreateSoundContainer("Mech GalilSAR", "SandstormSecurity.rte");
	self.mechSounds.End = CreateSoundContainer("MechEnd GalilSAR", "SandstormSecurity.rte");
	...
	self.reloadPrepareSounds.MagOut = CreateSoundContainer("MagOutPrepare GalilSAR", "SandstormSecurity.rte");
	self.reloadPrepareSounds.MagIn = CreateSoundContainer("MagInPrepare GalilSAR", "SandstormSecurity.rte");
	self.reloadPrepareSounds.BoltBack = CreateSoundContainer("BoltBackPrepare GalilSAR", "SandstormSecurity.rte");
	...
	self.reloadAfterSounds.MagOut = CreateSoundContainer("MagOut GalilSAR", "SandstormSecurity.rte");
	self.reloadAfterSounds.MagIn = CreateSoundContainer("MagIn GalilSAR", "SandstormSecurity.rte");
	self.reloadAfterSounds.BoltBack = CreateSoundContainer("BoltBack GalilSAR", "SandstormSecurity.rte");
	self.reloadAfterSounds.BoltForward = CreateSoundContainer("BoltForward GalilSAR", "SandstormSecurity.rte");
		...
		if self.reloadTimer:IsPastSimMS(self.reloadDelay) then
			...
			if self.afterSoundPlayed ~= true then
				...
				if self.reloadPhase == 0 then
					self.phaseOnStop = 1;
					local fake
					fake = CreateMOSRotating("Fake Magazine MOSRotating GalilSAR");
