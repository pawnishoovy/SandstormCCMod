function Create(self)
	...
	["Path"] = "SandstormSecurity.rte/Devices/Weapons/Handheld/HoneyBadger/CompliSoundV2/AddStart"};
	self.addSounds.Loop = {["Variations"] = 10,
	["Path"] = "SandstormSecurity.rte/Devices/Weapons/Handheld/HoneyBadger/CompliSoundV2/Add"};
	
	self.bassSounds = {["Start"] = nil, ["Loop"] = nil};
	self.bassSounds.Start = {["Variations"] = 4,
	["Path"] = "SandstormSecurity.rte/Devices/Weapons/Handheld/HoneyBadger/CompliSoundV2/BassStart"};
	self.bassSounds.Loop = {["Variations"] = 15,
	["Path"] = "SandstormSecurity.rte/Devices/Weapons/Handheld/HoneyBadger/CompliSoundV2/Bass"};
	
	self.mechSounds = {["Start"] = nil, ["Loop"] = nil, ["End"] = nil};
	self.mechSounds.Start = {["Variations"] = 4,
	["Path"] = "SandstormSecurity.rte/Devices/Weapons/Handheld/HoneyBadger/CompliSoundV2/MechStart"};
	self.mechSounds.Loop = {["Variations"] = 15,
	["Path"] = "SandstormSecurity.rte/Devices/Weapons/Handheld/HoneyBadger/CompliSoundV2/Mech"};
	self.mechSounds.End = {["Variations"] = 4,
	["Path"] = "SandstormSecurity.rte/Devices/Weapons/Handheld/HoneyBadger/CompliSoundV2/MechEnd"};
	...
	["Path"] = "SandstormSecurity.rte/Devices/Weapons/Handheld/HoneyBadger/CompliSoundV2/NoiseOutdoors"};
	self.noiseSounds.Outdoors.End = {["Variations"] = 4,
	["Path"] = "SandstormSecurity.rte/Devices/Weapons/Handheld/HoneyBadger/CompliSoundV2/NoiseOutdoorsEnd"};
	self.noiseSounds.Indoors.Loop = {["Variations"] = 5,
	["Path"] = "SandstormSecurity.rte/Devices/Weapons/Handheld/HoneyBadger/CompliSoundV2/NoiseIndoors"};
	self.noiseSounds.Indoors.End = {["Variations"] = 4,
	["Path"] = "SandstormSecurity.rte/Devices/Weapons/Handheld/HoneyBadger/CompliSoundV2/NoiseIndoorsEnd"};
	self.noiseSounds.bigIndoors.Loop = {["Variations"] = 5,
	["Path"] = "SandstormSecurity.rte/Devices/Weapons/Handheld/HoneyBadger/CompliSoundV2/NoiseBigIndoors"};
	self.noiseSounds.bigIndoors.End = {["Variations"] = 4,
	["Path"] = "SandstormSecurity.rte/Devices/Weapons/Handheld/HoneyBadger/CompliSoundV2/NoiseBigIndoorsEnd"};
	
	self.reflectionSounds = {["Outdoors"] = nil};
	self.reflectionSounds.Outdoors = {["Variations"] = 3,
	["Path"] = "SandstormSecurity.rte/Devices/Weapons/Handheld/HoneyBadger/CompliSoundV2/ReflectionOutdoors"};
	...
	self.magInPrepareDelay = 650;
	self.magInAfterDelay = 200;
	self.magHitPrepareDelay = 300;
	self.magHitAfterDelay = 400;
	self.boltForwardPrepareDelay = 500;
	...
	self.recoilStrength = 6.5 -- multiplier for base recoil added to the self.recoilStr when firing
	self.recoilPowStrength = 0.5 -- multiplier for self.recoilStr when firing
	self.recoilRandomUpper = 2.2 -- upper end of random multiplier (1 is lower)
...
function Update(self)
	...
	if self:IsReloading() then
		...
		if self.reloadPhase == 0 then
			...
			"SandstormSecurity.rte/Devices/Weapons/Handheld/HoneyBadger/Sounds/MagOutPrepare1";
			self.afterSoundPath = 
			"SandstormSecurity.rte/Devices/Weapons/Handheld/HoneyBadger/Sounds/MagOut1";
		...
		elseif self.reloadPhase == 1 then
			...
			self.prepareSoundPath = 
			"SandstormSecurity.rte/Devices/Weapons/Handheld/HoneyBadger/Sounds/MagInPrepare1";
			self.afterSoundPath = 
			"SandstormSecurity.rte/Devices/Weapons/Handheld/HoneyBadger/Sounds/MagIn1";
		...
		elseif self.reloadPhase == 2 then
			...
			self.afterSoundPath = 
			"SandstormSecurity.rte/Devices/Weapons/Handheld/HoneyBadger/Sounds/MagHit1";
		...
		elseif self.reloadPhase == 3 then
			...
			self.prepareSoundPath = nil;
			self.afterSoundPath = 
			"SandstormSecurity.rte/Devices/Weapons/Handheld/HoneyBadger/Sounds/BoltRelease1";
		...
		if self.reloadTimer:IsPastSimMS(self.reloadDelay) then
			...
			if self.afterSoundPlayed ~= true then
				...
				if self.reloadPhase == 0 then
					self.phaseOnStop = 1;
					local fake
					fake = CreateMOSRotating("Fake Magazine MOSRotating HoneyBadger");
	...
	if self.FiredFrame then	
		...
		if self.parent then
			...
			if controller:IsState(Controller.BODY_CROUCH) then
				...
				self.recoilRandomUpper = 2.0
				self.recoilDamping = 1.2
				
				self.recoilMax = 20
			else
				self.recoilStrength = 6.5
