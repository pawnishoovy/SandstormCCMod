function Create(self)
	...
	self.addSounds.Start = CreateSoundContainer("AddStart HoneyBadger", "SandstormSecurity.rte");
	self.addSounds.Loop = CreateSoundContainer("Add HoneyBadger", "SandstormSecurity.rte");
	
	self.bassSounds = {["Start"] = nil, ["Loop"] = nil};
	self.bassSounds.Start = CreateSoundContainer("BassStart HoneyBadger", "SandstormSecurity.rte");
	self.bassSounds.Loop = CreateSoundContainer("Bass HoneyBadger", "SandstormSecurity.rte");
	
	self.mechSounds = {["Start"] = nil, ["Loop"] = nil, ["End"] = nil};
	self.mechSounds.Start = CreateSoundContainer("MechStart HoneyBadger", "SandstormSecurity.rte");
	self.mechSounds.Loop = CreateSoundContainer("Mech HoneyBadger", "SandstormSecurity.rte");
	self.mechSounds.End = CreateSoundContainer("MechEnd HoneyBadger", "SandstormSecurity.rte");
	...
	self.reloadPrepareSounds.MagOut = CreateSoundContainer("MagOutPrepare HoneyBadger", "SandstormSecurity.rte");
	self.reloadPrepareSounds.MagIn = CreateSoundContainer("MagInPrepare HoneyBadger", "SandstormSecurity.rte");
	
	self.reloadPrepareLengths = {["MagOut"] = nil, ["MagIn"] = nil,  ["MagHit"] = nil, ["BoltForward"] = nil}
	self.reloadPrepareLengths.MagOut = 345;
	self.reloadPrepareLengths.MagIn = 670;
	
	self.reloadAfterSounds = {["MagOut"] = nil, ["MagIn"] = nil, ["MagHit"] = nil, ["BoltForward"] = nil}
	self.reloadAfterSounds.MagOut = CreateSoundContainer("MagOut HoneyBadger", "SandstormSecurity.rte");
	self.reloadAfterSounds.MagIn = CreateSoundContainer("MagIn HoneyBadger", "SandstormSecurity.rte");
	self.reloadAfterSounds.MagHit = CreateSoundContainer("MagHit HoneyBadger", "SandstormSecurity.rte");
	self.reloadAfterSounds.BoltForward = CreateSoundContainer("BoltForward HoneyBadger", "SandstormSecurity.rte");
	...
	self.magOutAfterDelay = 480;
	self.magInPrepareDelay = 670;
