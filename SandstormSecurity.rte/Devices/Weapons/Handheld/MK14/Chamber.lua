function Create(self)
	...
	self.sharpAimSounds.In = CreateSoundContainer("SharpAimIn MK14", "SandstormSecurity.rte");
	self.sharpAimSounds.Out = CreateSoundContainer("SharpAimOut MK14", "SandstormSecurity.rte");
	
	self.addSounds = {["Loop"] = nil};
	self.addSounds.Loop = CreateSoundContainer("Add MK14", "SandstormSecurity.rte");
	
	self.bassSounds = {["Loop"] = nil};
	self.bassSounds.Loop = CreateSoundContainer("Bass MK14", "SandstormSecurity.rte");
	
	self.mechSounds = {["Loop"] = nil};
	self.mechSounds.Loop = CreateSoundContainer("Mech MK14", "SandstormSecurity.rte");
	
	self.noiseSounds = {["Outdoors"] = {["Loop"] = nil, ["End"] = nil},
	["Indoors"] = {["Loop"] = nil, ["End"] = nil},
	["bigIndoors"] = {["Loop"] = nil, ["End"] = nil}};
	self.noiseSounds.Outdoors.End = CreateSoundContainer("NoiseOutdoorsEnd MK14", "SandstormSecurity.rte");
	self.noiseSounds.Outdoors.End.Pitch = 1.0;
	self.noiseSounds.Indoors.End = CreateSoundContainer("NoiseIndoorsEnd MK14", "SandstormSecurity.rte");
	self.noiseSounds.Indoors.End.Pitch = 1.0;
	self.noiseSounds.bigIndoors.End = CreateSoundContainer("NoiseBigIndoorsEnd MK14", "SandstormSecurity.rte");
	...
	self.reloadPrepareSounds.MagOut = CreateSoundContainer("MagOutPrepare MK14", "SandstormSecurity.rte");
	self.reloadPrepareSounds.MagIn = CreateSoundContainer("MagInPrepare MK14", "SandstormSecurity.rte");
	
	self.reloadPrepareLengths = {["MagOut"] = nil, ["MagIn"] = nil, ["BoltBack"] = nil, ["BoltForward"] = nil}
	self.reloadPrepareLengths.MagOut = 700;
	self.reloadPrepareLengths.MagIn = 650;
	
	self.reloadAfterSounds = {["MagOut"] = nil, ["MagIn"] = nil, ["BoltBack"] = nil, ["BoltForward"] = nil}
	self.reloadAfterSounds.MagOut = CreateSoundContainer("MagOut MK14", "SandstormSecurity.rte");
	self.reloadAfterSounds.MagIn = CreateSoundContainer("MagIn MK14", "SandstormSecurity.rte");
	self.reloadAfterSounds.BoltBack = CreateSoundContainer("BoltBack MK14", "SandstormSecurity.rte");
	self.reloadAfterSounds.BoltForward = CreateSoundContainer("BoltForward MK14", "SandstormSecurity.rte");
