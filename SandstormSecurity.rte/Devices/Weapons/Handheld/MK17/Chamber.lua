function Create(self)
	...
	self.sharpAimSounds.In = CreateSoundContainer("SharpAimIn MK17", "SandstormSecurity.rte");
	self.sharpAimSounds.Out = CreateSoundContainer("SharpAimOut MK17", "SandstormSecurity.rte");	
	
	self.addSounds = {["Start"] = nil, ["Loop"] = nil};
	self.addSounds.Start = CreateSoundContainer("AddStart MK17", "SandstormSecurity.rte");
	self.addSounds.Loop = CreateSoundContainer("Add MK17", "SandstormSecurity.rte");
	
	self.bassSounds = {["Loop"] = nil};
	self.bassSounds.Loop = CreateSoundContainer("Bass MK17", "SandstormSecurity.rte");
	
	self.mechSounds = {["Start"] = nil, ["Loop"] = nil, ["End"] = nil};
	self.mechSounds.Start = CreateSoundContainer("MechStart MK17", "SandstormSecurity.rte");
	self.mechSounds.Loop = CreateSoundContainer("Mech MK17", "SandstormSecurity.rte");
	self.mechSounds.End = CreateSoundContainer("MechEnd MK17", "SandstormSecurity.rte");
	...
	self.reloadPrepareSounds.MagOut = CreateSoundContainer("MagOutPrepare MK17", "SandstormSecurity.rte");
	self.reloadPrepareSounds.MagIn = CreateSoundContainer("MagInPrepare MK17", "SandstormSecurity.rte");
	...
	self.reloadAfterSounds.MagOut = CreateSoundContainer("MagOut MK17", "SandstormSecurity.rte");
	self.reloadAfterSounds.MagIn = CreateSoundContainer("MagIn MK17", "SandstormSecurity.rte");
	self.reloadAfterSounds.MagHit = CreateSoundContainer("MagHit MK17", "SandstormSecurity.rte");
	self.reloadAfterSounds.BoltForward = CreateSoundContainer("BoltForward MK17", "SandstormSecurity.rte");
		...
		if self.reloadTimer:IsPastSimMS(self.reloadDelay) then
			...
			if self.afterSoundPlayed ~= true then
				...
				if self.reloadPhase == 0 then
					...
					fake.Pos = self.Pos + Vector(-3, 2):RadRotate(self.RotAngle);
