function Create(self)
	...
	self.addSounds.Start = CreateSoundContainer("AddStart MK18", "SandstormSecurity.rte");
	self.addSounds.Loop = CreateSoundContainer("Add MK18", "SandstormSecurity.rte");
	
	self.bassSounds = {["Loop"] = nil};
	self.bassSounds.Loop = CreateSoundContainer("Bass MK18", "SandstormSecurity.rte");
	
	self.mechSounds = {["Start"] = nil, ["Loop"] = nil, ["End"] = nil};
	self.mechSounds.Start = CreateSoundContainer("MechStart MK18", "SandstormSecurity.rte");
	self.mechSounds.Loop = CreateSoundContainer("Mech MK18", "SandstormSecurity.rte");
	self.mechSounds.End = CreateSoundContainer("MechEnd MK18", "SandstormSecurity.rte");
	...
	self.reloadPrepareSounds.MagOut = CreateSoundContainer("MagOutPrepare MK18", "SandstormSecurity.rte");
	self.reloadPrepareSounds.MagIn = CreateSoundContainer("MagInPrepare MK18", "SandstormSecurity.rte");
	
	self.reloadPrepareLengths = {["MagOut"] = nil, ["MagIn"] = nil, ["BoltForward"] = nil}
	self.reloadPrepareLengths.MagOut = 400;
	self.reloadPrepareLengths.MagIn = 740;
	
	self.reloadAfterSounds = {["MagOut"] = nil, ["MagIn"] = nil, ["BoltForward"] = nil}
	self.reloadAfterSounds.MagOut = CreateSoundContainer("MagOut MK18", "SandstormSecurity.rte");
	self.reloadAfterSounds.MagIn = CreateSoundContainer("MagIn MK18", "SandstormSecurity.rte");
	self.reloadAfterSounds.BoltForwardRelease = CreateSoundContainer("BoltRelease MK18", "SandstormSecurity.rte");
	self.reloadAfterSounds.BoltBack = CreateSoundContainer("BoltBack MK18", "SandstormSecurity.rte");
	self.reloadAfterSounds.BoltForward = CreateSoundContainer("BoltForward MK18", "SandstormSecurity.rte");
	...
	if self:IsReloading() then
		...
		if self.reloadTimer:IsPastSimMS(self.reloadDelay) then
			...
			if self.reloadTimer:IsPastSimMS(self.reloadDelay + self.afterDelay) then
				...
				elseif self.reloadPhase == 1 or self.reloadPhase == 2 or self.reloadPhase == 4 then
					self.ReloadTime = 0;
					self.reloadPhase = 0;
					self.phaseOnStop = nil;
				else
