function Create(self)
	...
	["Path"] = "SandstormSecurity.rte/Devices/Weapons/Handheld/MP5A5/CompliSoundV2/AddStart"};
	...
	["Path"] = "SandstormSecurity.rte/Devices/Weapons/Handheld/MP5A5/CompliSoundV2/Mech"};
	self.mechSounds.End = {["Variations"] = 1,
	["Path"] = "SandstormSecurity.rte/Devices/Weapons/Handheld/MP5A5/CompliSoundV2/MechEnd"};
	...
	["Path"] = "SandstormSecurity.rte/Devices/Weapons/Handheld/MP5A5/CompliSoundV2/NoiseOutdoors"};
	self.noiseSounds.Outdoors.End = {["Variations"] = 4,
	["Path"] = "SandstormSecurity.rte/Devices/Weapons/Handheld/MP5A5/CompliSoundV2/NoiseOutdoorsEnd"};
	self.noiseSounds.Indoors.Loop = {["Variations"] = 15,
	["Path"] = "SandstormSecurity.rte/Devices/Weapons/Handheld/MP5A5/CompliSoundV2/NoiseIndoors"};
	self.noiseSounds.Indoors.End = {["Variations"] = 8,
	["Path"] = "SandstormSecurity.rte/Devices/Weapons/Handheld/MP5A5/CompliSoundV2/NoiseIndoorsEnd"};
	self.noiseSounds.bigIndoors.Loop = {["Variations"] = 15,
	["Path"] = "SandstormSecurity.rte/Devices/Weapons/Handheld/MP5A5/CompliSoundV2/NoiseBigIndoors"};
	self.noiseSounds.bigIndoors.End = {["Variations"] = 6,
	["Path"] = "SandstormSecurity.rte/Devices/Weapons/Handheld/MP5A5/CompliSoundV2/NoiseBigIndoorsEnd"};
	
	self.reflectionSounds = {["Outdoors"] = nil};
	self.reflectionSounds.Outdoors = {["Variations"] = 3,
	["Path"] = "SandstormSecurity.rte/Devices/Weapons/Handheld/MP5A5/CompliSoundV2/ReflectionOutdoors"};
