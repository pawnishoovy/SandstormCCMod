function Create(self)
	...
	self.sharpAimSounds.In = CreateSoundContainer("SharpAimIn MP5A5", "SandstormSecurity.rte");
	self.sharpAimSounds.Out = CreateSoundContainer("SharpAimOut MP5A5", "SandstormSecurity.rte");	
	
	self.addSounds = {["Start"] = nil, ["Loop"] = nil};
	self.addSounds.Start = CreateSoundContainer("AddStart MP5A5", "SandstormSecurity.rte");
	self.addSounds.Loop = CreateSoundContainer("Add MP5A5", "SandstormSecurity.rte");
	
	self.bassSounds = {["Start"] = nil, ["Loop"] = nil};
	self.bassSounds.Start = CreateSoundContainer("BassStart MP5A5", "SandstormSecurity.rte");
	self.bassSounds.Loop = CreateSoundContainer("Bass MP5A5", "SandstormSecurity.rte");
	
	self.mechSounds = {["Start"] = nil, ["Loop"] = nil, ["End"] = nil};
	self.mechSounds.Loop = CreateSoundContainer("Mech MP5A5", "SandstormSecurity.rte");
	self.mechSounds.End = CreateSoundContainer("MechEnd MP5A5", "SandstormSecurity.rte");
	...
	self.reloadPrepareSounds.BoltBack = CreateSoundContainer("BoltBackPrepare MP5A5", "SandstormSecurity.rte");
	self.reloadPrepareSounds.MagOut = CreateSoundContainer("MagOutPrepare MP5A5", "SandstormSecurity.rte");
	self.reloadPrepareSounds.MagIn = CreateSoundContainer("MagInPrepare MP5A5", "SandstormSecurity.rte");
	...
	self.reloadAfterSounds.BoltBack = CreateSoundContainer("BoltBack MP5A5", "SandstormSecurity.rte");
	self.reloadAfterSounds.BoltLock = CreateSoundContainer("BoltLock MP5A5", "SandstormSecurity.rte");
	self.reloadAfterSounds.MagOut = CreateSoundContainer("MagOut MP5A5", "SandstormSecurity.rte");
	self.reloadAfterSounds.MagIn = CreateSoundContainer("MagIn MP5A5", "SandstormSecurity.rte");
	self.reloadAfterSounds.BoltSlap = CreateSoundContainer("BoltSlap MP5A5", "SandstormSecurity.rte");
