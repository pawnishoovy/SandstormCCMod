function Create(self)
	...
	self.sharpAimSounds.In = CreateSoundContainer("SharpAimIn MP7", "SandstormSecurity.rte");
	self.sharpAimSounds.Out = CreateSoundContainer("SharpAimOut MP7", "SandstormSecurity.rte");		
	
	self.addSounds = {["Start"] = nil, ["Loop"] = nil};
	self.addSounds.Start = CreateSoundContainer("AddStart MP7", "SandstormSecurity.rte");
	self.addSounds.Loop = CreateSoundContainer("Add MP7", "SandstormSecurity.rte");
	
	self.bassSounds = {["Loop"] = nil};
	self.bassSounds.Loop = CreateSoundContainer("Bass MP7", "SandstormSecurity.rte");
	
	self.mechSounds = {["Start"] = nil, ["Loop"] = nil, ["End"] = nil};
	self.mechSounds.Start = CreateSoundContainer("MechStart MP7", "SandstormSecurity.rte");
	self.mechSounds.Loop = CreateSoundContainer("Mech MP7", "SandstormSecurity.rte");
	self.mechSounds.End = CreateSoundContainer("MechEnd MP7", "SandstormSecurity.rte");
	...
	self.reflectionSounds.Outdoors.Pitch = 1.1
	
	self.reloadPrepareSounds = {["MagOut"] = nil, ["MagIn"] = nil, ["BoltForward"] = nil}
	self.reloadPrepareSounds.MagOut = CreateSoundContainer("MagOutPrepare MP7", "SandstormSecurity.rte");
	self.reloadPrepareSounds.MagIn = CreateSoundContainer("MagInPrepare MP7", "SandstormSecurity.rte");
	
	self.reloadPrepareLengths = {["MagOut"] = nil, ["MagIn"] = nil, ["BoltForward"] = nil}
	self.reloadPrepareLengths.MagOut = 300;
	self.reloadPrepareLengths.MagIn = 730;
	
	self.reloadAfterSounds = {["MagOut"] = nil, ["MagIn"] = nil, ["BoltForward"] = nil}
	self.reloadAfterSounds.MagOut = CreateSoundContainer("MagOut MP7", "SandstormSecurity.rte");
	self.reloadAfterSounds.MagIn = CreateSoundContainer("MagIn MP7", "SandstormSecurity.rte");
	self.reloadAfterSounds.BoltForward = CreateSoundContainer("BoltForward MP7", "SandstormSecurity.rte");
		...
		if self.reloadTimer:IsPastSimMS(self.reloadDelay) then
			...
			if self.afterSoundPlayed ~= true then
				...
				if self.reloadPhase == 0 then
					self.phaseOnStop = 1;
					local fake
					fake = CreateMOSRotating("Fake Magazine MOSRotating MP7");
