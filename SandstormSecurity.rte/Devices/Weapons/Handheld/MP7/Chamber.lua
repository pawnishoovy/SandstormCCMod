function Create(self)
	...
	["Path"] = "SandstormSecurity.rte/Devices/Weapons/Handheld/MP7/CompliSoundV2/AddStart"};
	self.addSounds.Loop = {["Variations"] = 15,
	["Path"] = "SandstormSecurity.rte/Devices/Weapons/Handheld/MP7/CompliSoundV2/Add"};
	
	self.bassSounds = {["Loop"] = nil};
	self.bassSounds.Loop = {["Variations"] = 15,
	["Path"] = "SandstormSecurity.rte/Devices/Weapons/Handheld/MP7/CompliSoundV2/Bass"};
	
	self.mechSounds = {["Start"] = nil, ["Loop"] = nil, ["End"] = nil};
	self.mechSounds.Start = {["Variations"] = 4,
	["Path"] = "SandstormSecurity.rte/Devices/Weapons/Handheld/MP7/CompliSoundV2/MechStart"};
	self.mechSounds.Loop = {["Variations"] = 15,
	["Path"] = "SandstormSecurity.rte/Devices/Weapons/Handheld/MP7/CompliSoundV2/Mech"};
	self.mechSounds.End = {["Variations"] = 1,
	["Path"] = "SandstormSecurity.rte/Devices/Weapons/Handheld/MP7/CompliSoundV2/MechEnd"};
	...
	["Path"] = "SandstormSecurity.rte/Devices/Weapons/Handheld/MP7/CompliSoundV2/ReflectionOutdoors"};
...
function Update(self)
	...
	if self:IsReloading() then
		...
		if self.reloadPhase == 0 then
			...
			"SandstormSecurity.rte/Devices/Weapons/Handheld/MP7/Sounds/MagOutPrepare1";
			self.afterSoundPath = 
			"SandstormSecurity.rte/Devices/Weapons/Handheld/MP7/Sounds/MagOut1";
		...
		elseif self.reloadPhase == 1 then
			...
			self.prepareSoundPath = 
			"SandstormSecurity.rte/Devices/Weapons/Handheld/MP7/Sounds/MagInPrepare1";
			self.afterSoundPath = 
			"SandstormSecurity.rte/Devices/Weapons/Handheld/MP7/Sounds/MagIn1";
		...
		elseif self.reloadPhase == 2 then
			...
			self.afterSoundPath = 
			"SandstormSecurity.rte/Devices/Weapons/Handheld/MP7/Sounds/BoltRelease1";
