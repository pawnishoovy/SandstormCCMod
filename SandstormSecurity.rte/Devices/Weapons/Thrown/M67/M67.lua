function Create(self)
	...
	self.pullPinSound = CreateSoundContainer("M67 PullPin", "SandstormSecurity.rte");
	self.spoonEjectSound = CreateSoundContainer("M67 SpoonEject", "SandstormSecurity.rte");
