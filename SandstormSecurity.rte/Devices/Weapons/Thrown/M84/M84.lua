function Create(self)
	...
	self.pullPinSound = CreateSoundContainer("M84 PullPin", "SandstormSecurity.rte");
	self.spoonEjectSound = CreateSoundContainer("M84 SpoonEject", "SandstormSecurity.rte");
