function Create(self)
	...
	self.pullPinSound = CreateSoundContainer("MK3A2 PullPin", "SandstormSecurity.rte");
	self.spoonEjectSound = CreateSoundContainer("MK3A2 SpoonEject", "SandstormSecurity.rte");
